<template>
    <div class="row" style="position: relative">
        ...
        <div class="container-fluid index-text-container">
            <div class="row mobile-padding">
                <div class="col-md-6 col-md-offset-2 col-sm-10 col-xs-12 headline">
                    Beautiful design,<br>
                    pragmatic approach.
                </div>
            </div>
            <div class="row mobile-padding">
                <div class="col-md-5 col-md-offset-2 col-sm-8 col-xs-10 mobile-text">
